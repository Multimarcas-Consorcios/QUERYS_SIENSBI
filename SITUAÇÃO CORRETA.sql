...
WHERE
	...
	and cotas.proposta not in ('633247','688417','445021')
...
SELECT 
    ...
    cotas.proposta,
    cotas.situacoes,
    SUBSTRING(trim(cotas.situacoes),-4,(length(cotas.situacoes))) atual,
case
    ...
    siens_bi.cotas cotas
WHERE 
    cotas.situacoes REGEXP '8|10|401|425|437|439|440|443|444|446|447|448|449|450|451|452|453|454|455|456|465|470|473|486|500|501|507|515|518|523|528'
...
select
	...
	cotas.qtdeAtrasos as qtde_parc_inad
from
	siens_bi.cotas cotas  
where
