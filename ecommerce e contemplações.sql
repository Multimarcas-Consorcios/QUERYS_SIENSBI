SELECT count(*),x.tipoContemplacao  FROM siens_bi.cotas x
WHERE x.dataContemplacao = '2024-02-07'
GROUP by x.tipoContemplacao
;
select * from ecommerce_api ec
where ec.GRUPO in ('02033','02041','02061','02051','02059','02054','02063','02069','02045','02055','02056','02050');
...
select * from siens_bi.cotas where dataAtivacao is not null
and dataAtivacao > '2024-02-01'
and dataVenda >'2024-02-01'